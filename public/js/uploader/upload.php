...
if ( false ) {
	echo("No tienes permitido subir archivos");
	die(0);
}
...
//$basePath = "C:/xampp/htdocs/aclisa/public/files/";
$basePath = $_SERVER['DOCUMENT_ROOT'] . '/uploads/novedades/';
